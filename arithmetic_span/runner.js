...
(function() {
  ...
  this.AST.start = (function(_this) {
    return function(sessionNumber, subjectNumber) {
      var design_both, design_mul, design_sub, separator;
      _this.context = context;
      if (subjectNumber != null) {
        _this.context.set("subjectNumber", subjectNumber);
      } else {
        sessionNumber = 1;
      }
      if (sessionNumber != null) {
        _this.context.set("sessionNumber", subjectNumber);
      }
      ...
      _this.design_prac = Psy.loadTable("design/AST_Practice.txt", separator = ",");
      _this.design_sub = Psy.loadTable("design/AST_SubList" + sessionNumber + ".txt", separator = ",");
      _this.design_mul = Psy.loadTable("design/AST_MulList" + sessionNumber + ".txt", separator = ",");
      design_sub = _this.design_sub.shuffle();
      design_mul = _this.design_mul.shuffle();
      design_both = Psy.DataTable.rbind2(design_sub, design_mul);
      _this.AST.trialsPart1 = Psy.TrialList.fromBlock(design_both);
      _this.AST.trialsPractice = Psy.TrialList.fromBlock(design_prac);
      _this.pres = new Psy.Presentation({}, _this.AST.experiment, _this.context);
